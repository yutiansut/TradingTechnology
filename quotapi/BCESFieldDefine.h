...
public:
	...
	BML_FIELD_INFO m_fieldarray_PosiDetail[30];
...
public:
	CBCESFieldsInstrument()
	{
		...
		AddField((void*)&LimitedFilledPoints,sizeof(LimitedFilledPoints),NULL,0,bces_rulearray+BCESFieldIndexLimitedFilledPoints);	/* 最小成交滑点 */
		AddField((void*)&LimitedOrderPoints,sizeof(LimitedOrderPoints),NULL,0,bces_rulearray+BCESFieldIndexLimitedOrderPoints);	/* 最小报价点差 */
		AddField((void*)&LimitedStopPoints,sizeof(LimitedStopPoints),NULL,0,bces_rulearray+BCESFieldIndexLimitedStopPoints);	/* 最小止赢止损点差 */
		AddField((void*)Address,sizeof(Address),NULL,0,bces_rulearray+BCESFieldIndexAddress);	/* 产地 */
		AddField((void*)WareHouse,sizeof(WareHouse),NULL,0,bces_rulearray+BCESFieldIndexWareHouse);	/* 仓库 */
	...
	BML_FIELD_INFO m_fieldarray_Instrument[29];
