...
{
public:
	CServerConnector(boost::asio::io_service& io_service,const char* servaddr,unsigned int nTcpSndSiz,unsigned int nTcpRcvSiz,unsigned short nHeartbeatTimeout,CBCESQuotApiImp* pApi);
	~CServerConnector();
