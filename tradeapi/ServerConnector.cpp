...
CServerConnector::CServerConnector(boost::asio::io_service& io,const char* servaddr,unsigned int nTcpSndSiz,unsigned int nTcpRcvSiz,unsigned short nHeartbeatTimeout,CBCESTradeApiImp* pApi):
	m_io(io),
